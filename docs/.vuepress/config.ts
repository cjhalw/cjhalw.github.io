...
const DOMAIN_NAME = 'cjhalw.com' // 域名 (不带https)
...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
    ...
    themeConfig: {
        ...
        categoryText: '零碎文档', // 碎片化文章（_posts文件夹的文章）预设生成的分类值，默认'随笔'
        ...
        author: {
            name: 'cjhalw', // 必需
            link: 'https://github.com/cjhalw', // 可选的
        },
